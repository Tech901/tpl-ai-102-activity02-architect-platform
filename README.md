...
> - Picking a service that can technically do the job but isn't the best fit. Each department has **one best-fit service** based on its capability, pain point, and constraints. Read the scenario carefully — the grading tests expect a specific service per department.
